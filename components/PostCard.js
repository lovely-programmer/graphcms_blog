    ...
    <div className="bg-white shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8">
      ...
      <div className="block lg:flex text-center items-center justify-center mb-8">
        ...
        <div className="font-medium text-gray-700">
          ...
          <span className="align-middle">{format(post.createdAt)}</span>
        </div>
      </div>
      ...
      <div className="text-center">
        <Link href={`/post/${post.slug}`}>
          <span className="transition duration-500 transform hover:translate-y-1 inline-block bg-pink-600 text-lg font-medium text-white rounded-full cursor-pointer px-8 py-3">
            Continue Reading
          </span>
        </Link>
      </div>
